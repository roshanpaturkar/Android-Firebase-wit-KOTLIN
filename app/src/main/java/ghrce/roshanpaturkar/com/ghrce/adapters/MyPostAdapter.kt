...
class MyPostAdapter(dataBaseQuery: DatabaseReference, var context: Context)
    : FirebaseRecyclerAdapter<Post, MyPostAdapter.ViewHolder>(
        Post::class.java,
        R.layout.timeline_row,
        MyPostAdapter.ViewHolder::class.java,
        dataBaseQuery
) {
    ...
    override fun populateViewHolder(viewHolder: MyPostAdapter.ViewHolder?, post: Post?, position: Int) {
...
//        }
    ...
    private fun showMenu(key: String?) {
        ...
        val options = arrayOf("Like", "Dislike", "Comment", "View Post", "Delete")
    ...
    private fun deletePost(itemKey: String) {
