...
import ghrce.roshanpaturkar.com.ghrce.adapters.MyPostAdapter
 ...
 *
 */
class MyPostsFragments : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_my_posts_fragments, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mUserDatabase = FirebaseDatabase.getInstance().reference.child("GHRCE").child("UserPost").child(userId)
        myPostRecyclerView.setHasFixedSize(true)

        myPostRecyclerView.layoutManager = linearLayoutManager
        myPostRecyclerView.adapter = MyPostAdapter(mUserDatabase!!, context)
    }
